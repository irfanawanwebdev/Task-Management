...
import { Bell, CheckCheck, AlertTriangle, Calendar, FileText, ShieldAlert, Zap, Loader2 } from 'lucide-react'
...
export function NotificationBell() {
  ...
  return (
    <div ref={wrapRef} className="relative">
      ...
      {/* Dropdown */}
      {open && (
        <div className="absolute bottom-full left-0 mb-2 w-80 rounded-xl border bg-card shadow-lg overflow-hidden z-50">
          {/* Header */}
